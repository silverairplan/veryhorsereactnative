...
class MyProfile extends React.Component {
  ...
  validate = () => {
    let error = {};
    const {intlData} = this.props;
    if (this.state.user.type == 'user' && this.state.user.name === '') {
      error.name = intlData.messages['OBLIGATORIO'];
    }
    if (this.state.user.type == 'user' && this.state.user.lastname === '') {
      error.lastname = intlData.messages['OBLIGATORIO'];
    }
    if (this.state.user.address === '') {
      error.address = intlData.messages['OBLIGATORIO'];
    }
    if (this.state.user.idioma === null || this.state.user.idioma === '') {
      error.idioma = intlData.messages['OBLIGATORIO'];
    }
    if (this.state.user.town === '') {
      error.town = intlData.messages['OBLIGATORIO'];
    }
    if (this.state.user.cp === '') {
      error.cp = intlData.messages['OBLIGATORIO'];
    }
    if (this.state.user.country === '') {
      error.country = intlData.messages['OBLIGATORIO'];
    }
    ...
    if (this.state.user.prefixMob === '') {
      error.phoneMob = intlData.messages['OBLIGATORIO'];
    }
    if (this.state.user.phoneMob === '' || isNaN(this.state.user.phoneMob)) {
      error.phoneMob = intlData.messages['OBLIGATORIO'];
    }
    ...
    return (
      <PageContainer {...this.props} bannerenable={true} padding={true}>
          ...
          <View>
            ...
            {this.state.user.type != 'user' && (
              <View style={style.formgroup}>
                ...
                <TextInput
                  style={style.input}
                  value={this.state.user.name_empresa}
                  onChangeText={text => this.handleChange('name_empresa', text)}
                />
                  ...
                  <View style={style.dropdown}>
                    <Picker
                      ...
                      onValueChange={itemvalue =>
                        this.handleChange('idioma', itemvalue)
                      }
                      selectedValue={this.state.user.idioma}>
                      <Picker.Item
                        value=""
                        label={intlData.messages['IDIOMA']}
                      />
              ...
              <View style={style.formgroup}>
                ...
                <View style={{flexDirection: 'row'}}>
                  <View style={{flex: 1}}>
                    <TextInput
                      style={style.input}
                      value={this.state.user.numero_identificacion}
                      onChangeText={text =>
                        this.handleChange('numero_identificacion', text)
                      }
                    />
              ...
              <View style={{flexDirection: 'row'}}>
                <View style={{flex: 3, marginRight: wp('2%')}}>
                  <TextInput
                    ...
                    onChangeText={text => this.handleChange('town', text)}
                  />
                ...
                <View style={{flex: 2}}>
                  <TextInput
                    ...
                    onChangeText={text => this.handleChange('cp', text)}
                  />
                  {this.state.error.cp && (
            ...
            <View style={style.formgroup}>
              ...
              <View style={style.dropdown}>
                <Picker
                  ...
                  style={{flex: 1}}
                  onValueChange={itemvalue =>
                    this.handleChange('country', itemvalue)
                  }
                  selectedValue={this.state.user.country}>
                  <Picker.Item value="" label={intlData.messages['PAIS']} />
            ...
            {this.state.user.type != 'user' && (
              <View>
                <View style={style.formgroup}>
                  ...
                  <TextInput
                    style={style.input}
                    value={this.state.user.web}
                    onChangeText={text => this.handleChange('web', text)}
                  />
                </View>
                <View style={style.formgroup}>
                  ...
                  <AutoComplete
                    value={
                      this.state.user.interestedCountries
                        ? this.state.user.interestedCountries
                        : []
                    }
                    selectchange={value =>
                      this.handleChange('interestedCountries', value)
                    }
                    remove={this.remove}
                    intlData={intlData}
                  />
            ...
            <View style={{flexDirection: 'row', ...style.formgroup}}>
              <View style={{flex: 2, marginRight: wp('2%')}}>
                ...
                <View style={style.dropdown}>
                  <Picker
                    ...
                    style={{flex: 1}}
                    onValueChange={itemvalue =>
                      this.handleChange('prefixFix', itemvalue)
                    }
                    selectedValue={this.state.user.prefixFix}>
                    <Picker.Item
                      value=""
                      label={intlData.messages['PREFIJO']}
                    />
              ...
              <View style={{flex: 3}}>
                ...
                <TextInput
                  ...
                  style={style.input}
                  value={this.state.user.phoneFix}
                  onChangeText={text => this.handleChange('phoneFix', text)}
                />
            ...
            <View style={{flexDirection: 'row', ...style.formgroup}}>
              <View style={{flex: 2, marginRight: wp('2%')}}>
                ...
                <View style={style.dropdown}>
                  <Picker
                    ...
                    style={{flex: 1}}
                    onValueChange={itemvalue =>
                      this.handleChange('prefixMob', itemvalue)
                    }
                    selectedValue={this.state.user.prefixMob}>
                    <Picker.Item
                      value=""
                      label={intlData.messages['PREFIJO']}
                    />
              ...
              <View style={{flex: 3}}>
                ...
                <TextInput
                  keyboardType="number-pad"
                  style={style.input}
                  value={this.state.user.phoneMob}
                  onChangeText={text => this.handleChange('phoneMob', text)}
                />
            ...
            <View style={style.btncontainer}>
              ...
              <TouchableOpacity
                style={{marginLeft: 'auto', ...style.btn}}
                onPress={this.send}>
        ...
        <Modal
          ...
          onTouchOutside={() => this.setState({saved: false})}
          modalTitle={
            <ModalTitle
              title={intlData.messages['UPDATE_E']}
