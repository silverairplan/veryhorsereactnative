...
class MyDemandItem extends React.Component {
    ...
    AsyncStorage.getItem('user').then(user => {
      ...
      service.getdemanditem(demandid).then(async demand => {
        ...
        if (demand.acceptedProposal && demand.status == 'confirmed') {
          acceptedproposal = await service.getproposalitem(
            demandid,
            demand.acceptedProposal,
          );
          if (user.type == 'transportista') {
            accepteduser = await service.gettransportista(demand.user);
          } else {
            acceptedtransportista = await service.gettransportista(
              demand.userTrans,
            );
          }
        }
  ...
  title = type => {
    ...
    switch (data[type + 'Mod']) {
      case 'before':
        string =
          intlData.messages['ANTES_DIA'] +
          ' ' +
          Moment(new Date(data[type + 'DayIni'])).format('DD-MM-YYYY');
        break;
      case 'after':
        string =
          intlData.messages['DESPUES'] +
          ' ' +
          Moment(new Date(data[type + 'DayIni'])).format('DD-MM-YYYY');
        break;
      case 'day':
      ...
      case 'between':
        string =
          intlData.messages['ENTRE'] +
          ' ' +
          Moment(new Date(data[type + 'DayIni'])).format('DD-MM-YYYY') +
          ' ' +
          intlData.messages['Y_EL'] +
          ' ' +
          Moment(new Date(data[type + 'DayEnd'])).format('DD-MM-YYYY');
        break;
    }
      ...
      <View style={style.groupitem}>
        ...
        <View style={{flexDirection: 'row', ...style.groupitem}}>
          <Text style={style.label}>
            {intlData.messages['NOMBRE_E']} :{' '}
            <Text style={style.description}>
              {this.state.acceptedtransportista.name_empresa}
            </Text>
          </Text>
        </View>
        <View style={{flexDirection: 'row', ...style.groupitem}}>
          <Text style={style.label}>
            Email :{' '}
            <Text style={style.description}>
              {this.state.acceptedtransportista.email}
            </Text>
          </Text>
        </View>
        <View style={{flexDirection: 'row', ...style.groupitem}}>
          <Text style={style.label}>
            {intlData.messages['IDIOMA']} :{' '}
            <Text style={style.description}>
              {this.state.acceptedtransportista.idioma}
            </Text>
          </Text>
        </View>
        {this.state.acceptedproposal.vehicle > 0 && (
          <View style={style.groupitem}>
            ...
            <Image
              source={
                this.vehicle[this.state.acceptedproposal.vehicle - 1].image
              }
            />
          </View>
        )}
        <View style={{flexDirection: 'row', ...style.groupitem}}>
          <Text style={style.label}>
            {intlData.messages['DIRECCION']} :{' '}
            <Text style={style.description}>
              {this.state.acceptedtransportista.address}
            </Text>
          </Text>
        </View>
        <View style={{flexDirection: 'row', ...style.groupitem}}>
          <Text style={style.label}>
            {intlData.messages['POBLACION']} :{' '}
            <Text style={style.description}>
              {this.state.acceptedtransportista.town}
            </Text>
          </Text>
        </View>
        <View style={{flexDirection: 'row', ...style.groupitem}}>
          <Text style={style.label}>
            CP :{' '}
            <Text style={style.description}>
              {this.state.acceptedtransportista.cp}
            </Text>
          </Text>
        </View>
        <View style={{flexDirection: 'row', ...style.groupitem}}>
          <Text style={style.label}>
            {intlData.messages['PAIS']} :{' '}
            <Text style={style.description}>
              {this.state.acceptedtransportista.country}
            </Text>
          </Text>
        </View>
        {this.state.acceptedtransportista.phoneFix != undefined &&
          this.state.acceptedtransportista.phoneFix != '' && (
            <View style={{flexDirection: 'row', ...style.groupitem}}>
              <Text style={style.label}>
                {intlData.messages['TELEFONO_F']} :{' '}
                <Text style={style.description}>
                  {this.state.acceptedtransportista.prefixFix} -{' '}
                  {this.state.acceptedtransportista.phoneFix}
                </Text>
              </Text>
            </View>
        ...
        <View style={{flexDirection: 'row', ...style.groupitem}}>
          <Text style={style.label}>
            {intlData.messages['TELEFONO_M']} :{' '}
            <Text style={style.description}>
              {this.state.acceptedtransportista.prefixMob} -{' '}
              {this.state.acceptedtransportista.phoneMob}
            </Text>
          </Text>
        </View>
        {this.state.acceptedtransportista.web != undefined &&
          this.state.acceptedtransportista.web != '' && (
            <View style={{flexDirection: 'row', ...style.groupitem}}>
              <Text style={style.label}>
                Web :{' '}
                <Text style={style.description}>
  ...
  render() {
    ...
    if (this.state.origin && this.state.destination) {
      distance = service.getdistance(
        {lat: this.state.origin.latitude, long: this.state.origin.longitude},
      ...
      <PageContainer
          ...
          {this.state.origin && this.state.destination && (
            <View style={{marginTop: hp('2%')}}>
              ...
              <Text style={style.distance}>
                ...
                {this.state.distance ? this.state.distance : distance} km
              </Text>
            </View>
          )}
        </View>
        <View style={style.content}>
          ...
          <View style={{flexDirection: 'row', ...style.groupitem}}>
            ...
            <Text style={{marginLeft: wp('2%'), ...style.description}}>
              {this.state.data.numHorses}
            </Text>
          </View>
          <View style={style.groupitem}>
            <Text style={style.label}>{intlData.messages['TRATAMIENTO']}</Text>
            <Text style={style.description}>
              {this.state.data.specialDesc ? this.state.data.specialDesc : 'No'}
            </Text>
          </View>
          <View style={style.groupitem}>
            <Text style={style.label}>{intlData.messages['EQUIPAJE']}</Text>
            <Text style={style.description}>
              {this.state.data.lugage ? this.state.data.lugageDesc : 'No'}
            </Text>
          </View>
          {this.state.data.status == 'pending' && this.isTrans() && (
            <View>
              {this.state.myproposal && !this.state.proposalsent && (
                <Text style={{marginTop: hp('8%'), ...style.description}}>
                  {intlData.messages['PROPUESTA_YA_ENVIADA']}
                </Text>
              )}
                ...
                <View>
                  ...
                  <View style={style.groupitem}>
                    <RadioForm
                      ...
                      {[
                        {
                          label: intlData.messages['TRIP_ONE_WAY'],
                          value: 'one_way_trip',
                        },
                        {
                          label: intlData.messages['TRIP_ROUND'],
                          value: 'round_trip',
                        },
                      ].map((row, index) => {
                        return (
                          <RadioButton key={index} labelHorizontal={true}>
                            <RadioButtonInput
                              isSelected={
                                this.state.proposalitem.triptype == row.value
                              }
                              obj={row}
                              index={index}
                              buttonWidth={10}
                              ...
                              buttonSize={hp('1.5%')}
                              buttonOuterSize={hp('3.5%')}
                              onPress={value =>
                                this.handleChange('triptype', value)
                              }
                            />
                            <RadioButtonLabel
                              obj={row}
                  ...
                  <View style={style.groupitem}>
                    <Text style={style.label}>
                      {intlData.messages['VEHICULO']}
                    </Text>
                    <ImageSelect
                      images={this.vehicle}
                      value={this.state.proposalitem.vehicle}
                      selectimage={this.selectvehicle}
                    />
                  </View>
                  <View style={style.groupitem}>
                    <Text style={style.label}>
                      {intlData.messages['FECHA_A']}
                    </Text>
                  </View>
                  <View style={style.groupitem}>
                    <Text style={style.label}>
                      {intlData.messages['RECOGIDA']}
                    </Text>
                    <DatePicker
                      ...
                      onDateChange={date =>
                        this.handleChange('altPicDay', new Date(date).getTime())
                      }
                      date={
                        this.state.proposalitem.altPicDay
                          ? Moment(
                              new Date(this.state.proposalitem.altPicDay),
                            ).format('YYYY-MM-DD')
                          : ''
                      }
                  ...
                  <View style={style.groupitem}>
                    <Text style={style.label}>
                      {intlData.messages['ENTREGA']}
                    </Text>
                    <DatePicker
                      confirmBtnText={intlData.messages['ANULAR']}
                      cancelBtnText={intlData.messages['CANCELAR']}
                      mode="date"
                      style={style.forminput}
                      showIcon={false}
                      ...
                      onDateChange={date =>
                        this.handleChange('altDelDay', new Date(date).getTime())
                      }
                      date={
                        this.state.proposalitem.altDelDay
                          ? Moment(
                              new Date(this.state.proposalitem.altDelDay),
                            ).format('YYYY-MM-DD')
                          : ''
                      }
                  ...
                  <View
                    ...
                    {this.state.myproposal && (
                      <TouchableOpacity
                        style={style.btn}
                        onPress={() => this.setState({deletequote: true})}>
                        <Text style={style.description}>
                          {intlData.messages['DELETE_QUOTE']}
                        </Text>
                      </TouchableOpacity>
                    )}
                    <TouchableOpacity
                      style={{marginRight: wp('1%'), ...style.btn}}
                      onPress={this.sendproposal}>
                      <Text style={style.description}>
                        {intlData.messages['ENVIAR_COTIZACION']}{' '}
                        {this.state.myproposal
                          ? intlData.messages['NUEVA']
                          : ''}
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={style.btn}
                      onPress={() => this.setState({desetimar: true})}>
                      <Text style={style.description}>
                        {intlData.messages['DESESTIMAR']}
                      </Text>
                    </TouchableOpacity>
                  </View>
                </View>
                    ...
                    return (
                      <View key={index} style={style.item}>
                        <Text style={style.title}>
                          {intlData.messages['PRECIO5']}
                        </Text>
                        <Text style={style.price}>
                          {Util.demandamount(row.amount)} €
                        </Text>
                        <TouchableOpacity
                          style={style.buttonproposal}
                          onPress={() => this.viewproposal(row.id)}>
                          <Text
                            style={{textAlign: 'center', ...style.description}}>
                            {intlData.messages['VER']}{' '}
                            {intlData.messages['PROPUESTA']}
                          </Text>
                        </TouchableOpacity>
                      </View>
                    );
            ...
            <View style={style.groupitem}>
              <TouchableOpacity style={style.btn}>
                <Text
                  ...
                  {intlData.messages['ANULAR_DEMANDA']}
                </Text>
              </TouchableOpacity>
            </View>
          )}
          {this.state.data.status == 'confirmed' && (
            <View style={style.groupitem}>
              ...
              <View style={{marginTop: hp('3%'), ...style.groupitem}}>
                <Text style={style.label}>
                  {intlData.messages['PRECIO4']} :{' '}
                  <Text style={style.description}>
                    {Util.demandamount(this.state.acceptedproposal.amount)} €
                  </Text>
                </Text>
              </View>
              <View style={{flexDirection: 'row', ...style.groupitem}}>
                <Text style={style.label}>
                  {intlData.messages['PAGO']} :{' '}
                  <Text style={style.description}>
                    {Util.payamount(this.state.acceptedproposal.amount)} €
                  </Text>
                </Text>
              </View>
              <View style={{flexDirection: 'row', ...style.groupitem}}>
                <Text style={style.label}>
                  {intlData.messages['PAGO2']} :{' '}
                  <Text style={style.description}>
                    {this.state.acceptedproposal.amount} €
                  </Text>
                </Text>
              </View>
              {this.state.acceptedproposal.altPicDay && (
                <View style={style.groupitem}>
                  <Text style={style.label}>
                    {intlData.messages['PROPUESTA2']} :{' '}
                    <Text style={style.description}>
                      {Moment(
                        new Date(this.state.acceptedproposal.altPicDay),
                      ).format('DD-MM-YYYY')}
                    </Text>
                  </Text>
                </View>
              ...
              {this.state.acceptedproposal.altDelDay && (
                <View style={style.groupitem}>
                  <Text style={style.label}>
                    {intlData.messages['PROPUESTA3']} :{' '}
                    <Text style={style.description}>
                      {Moment(
                        new Date(this.state.acceptedproposal.altDelDay),
                      ).format('DD-MM-YYYY')}
                    </Text>
                  </Text>
                </View>
              ...
              {this.isTrans() && (
                <View style={style.groupitem}>
                  <Text style={{fontSize: hp('2.5%'), ...style.label}}>
                    {intlData.messages['DATOS2']}
                  </Text>
                  <View style={{flexDirection: 'row', ...style.groupitem}}>
                    <Text style={style.label}>
                      {intlData.messages['NOMBRE']} :
                    </Text>
                    <Text style={{marginLeft: wp('2%'), ...style.description}}>
                      {this.state.accepteduser.name}{' '}
                      {this.state.accepteduser.lastname}
                    </Text>
                  </View>
                  <View style={{flexDirection: 'row', ...style.groupitem}}>
                    <Text style={style.label}>
                    ...
                    <Text style={{marginLeft: wp('2%'), ...style.description}}>
                      {this.state.accepteduser.address}{' '}
                      {this.state.accepteduser.cp}{' '}
                      {this.state.accepteduser.town}{' '}
                      {this.state.accepteduser.country}
                    </Text>
                  </View>
                  {this.state.accepteduser.phoneFix != '' &&
                    this.state.accepteduser.phoneFix != undefined && (
                      <View style={{flexDirection: 'row', ...style.groupitem}}>
                        <Text style={style.label}>
                          {intlData.messages['DIRECCION']} :
                        </Text>
                        <Text
                          style={{marginLeft: wp('2%'), ...style.description}}>
                          {this.state.accepteduser.address}{' '}
                          {this.state.accepteduser.cp}{' '}
                          {this.state.accepteduser.town}{' '}
                          {this.state.accepteduser.country}
                  ...
                  <View style={{flexDirection: 'row', ...style.groupitem}}>
                    ...
                    <Text style={{marginLeft: wp('2%'), ...style.description}}>
                      {this.state.accepteduser.prefixMob}{' '}
                      {this.state.accepteduser.phoneMob}
                    </Text>
                  </View>
                  <View style={{flexDirection: 'row', ...style.groupitem}}>
                    <Text style={style.label}>Email :</Text>
                    <Text style={{marginLeft: wp('2%'), ...style.description}}>
                      {this.state.accepteduser.email}
                    </Text>
                  </View>
                </View>
              )}
        ...
        <Modal
          ...
          modalTitle={
            <ModalTitle title={intlData.messages['ANULAR_DEMANDA']} />
          }
          footer={
            <ModalFooter>
              <ModalButton
                style={style.btn}
                text={intlData.messages['ANULAR']}
                textStyle={style.description}
                onPress={() => this.deletedemand()}
              />
              <ModalButton
        ...
        <Modal
          ...
          modalTitle={<ModalTitle title={intlData.messages['DESESTIMAR']} />}
          footer={
            <ModalFooter>
              <ModalButton
                style={style.btn}
                text={intlData.messages['SI']}
                textStyle={style.description}
                onPress={() => this.desetimar()}
              />
              <ModalButton
                text={intlData.messages['NO']}
                onPress={() => this.setState({desetimar: false})}
              />
            </ModalFooter>
          }
          onTouchOutside={() => this.setState({confirm: false})}>
          <ModalContent>
            <Text style={style.confirmText}>
              {intlData.messages['ARE_YOU_SURE']}
            </Text>
          </ModalContent>
        </Modal>
        <Modal
          visible={this.state.deletequote}
          modalTitle={<ModalTitle title={intlData.messages['DELETE_QUOTE']} />}
          footer={
            <ModalFooter>
              <ModalButton
                style={style.btn}
              ...
              <ModalButton
                text={intlData.messages['NO']}
                onPress={() => this.setState({deletequote: false})}
              />
            </ModalFooter>
          }
