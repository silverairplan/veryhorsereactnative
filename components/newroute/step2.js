          ...
          <DatePicker
            ...
            minDate={
              this.props.param1 == 'pickDayIni'
                ...
                : Moment(new Date(this.props.data['pickDayIni'])).format(
                    'YYYY-MM-DD',
                  )
            }
            maxDate={
              this.props.param1 == 'pickDayIni' &&
              this.props.data['deliverDayIni']
                ? Moment(new Date(this.props.data['deliverDayIni'])).format(
                    'YYYY-MM-DD',
                  )
                : Moment(new Date(8640000000000000)).format('YYYY-MM-DD')
            }
            onDateChange={date =>
              this.props.handleChange(this.props.param1, date)
            }
