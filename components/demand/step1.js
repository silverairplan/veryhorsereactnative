        ...
        <View style={style.formgroup}>
            ...
            <GooglePlacesAutocomplete
              ...
              onPress={(data, details = null) => {
                ...
                for (let item in details.address_components) {
                  if (
                    details.address_components[item].types.indexOf('locality') >
                    -1
                  ) {
                  ...
                  if (
                    details.address_components[item].types.indexOf('country') >
                    -1
                  ) {
          ...
          {this.props.error[this.props.param1] != undefined && (
            <Text style={style.form_error}>
              {this.props.error[this.props.param1]}
            </Text>
          )}
        </View>
        <View style={style.formgroup}>
          ...
          <TextInput
            style={style.input}
            value={this.props.data[this.props.param2]}
            onChangeText={text =>
              this.props.handleChange(this.props.param2, text)
            }
          />
          {this.props.error[this.props.param2] != undefined && (
            <Text style={style.form_error}>
              {this.props.error[this.props.param2]}
            </Text>
          )}
        </View>
      </View>
