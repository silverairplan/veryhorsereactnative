  ...
  render() {
    return (
      <KeyboardAvoidingView behavior="padding" style={style.container}>
        <View
          style={this.props.padding ? style.containerpadding : style.container}>
          <View style={style.title}>
            {this.props.backenable && (
              <TouchableOpacity style={style.back} onPress={() => this.back()}>
                <Ionicons name="ios-arrow-round-back" style={style.backtext} />
              </TouchableOpacity>
            )}
            <Text style={style.titletext}>{this.props.title}</Text>
            <TouchableOpacity
              style={style.naviconcontainer}
              onPress={() => this.props.navigation.openDrawer()}>
              <Ionicons name="md-menu" style={style.navicon} />
            </TouchableOpacity>
          </View>
          <ScrollView
            style={
              this.props.padding ? style.containerpadding : style.container
            }
            keyboardShouldPersistTaps="handled">
            {this.state.banner && (
              <TouchableOpacity
                style={style.banner}
                onPress={() => Linking.openURL(this.state.banner.link)}>
                <Image
                  source={{uri: this.state.banner.image}}
                  style={style.banner}
                />
              </TouchableOpacity>
            )}
